from Shraman_loading_data_scene_kinds_150_Seg_Channels import MultiPartitioningClassifier
import yaml
...
class GeoClassification(nn.Module):
    ...
    def __init__(self):
        ...
        self.seg_model.conv1 = nn.Conv2d(150, 64, kernel_size=7, stride=2, padding=3,bias=False)
...
print(summary(model, [(3, 224, 224), (224, 224, 150)]))
