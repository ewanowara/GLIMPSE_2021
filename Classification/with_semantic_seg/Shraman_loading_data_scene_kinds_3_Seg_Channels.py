...
class MsgPackIterableDatasetMultiTargetWithDynLabels(torch.utils.data.IterableDataset):
    ...
    def _process_sample(self, x):
        ...
        if self.meta_path is None:
            ...
            with Image.open(self.seg_path + _id) as img_seg:
                # img_seg = np.array(im)
            ...
            return img, img_seg, x["target"], meta[self.lat_key], meta[self.lon_key], meta[self.scene_key]
...
class MultiPartitioningClassifier():
    ...
    def train_dataloader(self):
        ...
        with open(self.hparams.train_label_mapping, "r") as f:
            ...
            if self.hparams.scene_of_interest == 0 or self.hparams.scene_of_interest == 1 or self.hparams.scene_of_interest == 2: 
                ...
                meta = meta.loc[meta[scene_key] == self.hparams.scene_of_interest] 
        ...
        dataset = MsgPackIterableDatasetMultiTargetWithDynLabels(
            ...
            meta_path=self.hparams.train_meta_path,
            scene_of_interest=self.hparams.scene_of_interest,
            cache_size=1024,
        )
