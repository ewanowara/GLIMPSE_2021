...
class MultiPartitioningClassifier(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        # TODO: Fix error printint top-k accuracy
        ...
        # TODO: uncomment when individual_accuracy_dict fixed
        output = {
            "loss_val/total": loss,
    ...
    def inference(self, batch):
        ...
        for i in range(nparts):
            ...
            if self.hierarchy is not None and i == len(self.partitionings):
                ...
                # print(len(yhats))
                # print(len(yhats[0]))
                # print('pred_classes') # top predictions for the 13 images in a batch
                # print(pred_classes)
                
                # print('hierarchy_preds.shape')
                # print(hierarchy_preds.shape)
                # size: torch.Size([13, 12893]), 12893 for each image




                # Ewa: 
                # here the max probability output is taken
                # change to top k or all to get probability
