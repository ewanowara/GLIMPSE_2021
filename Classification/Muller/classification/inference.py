...
dataloader = torch.utils.data.DataLoader(
    FiveCropImageDataset(meta_csv=None, image_dir=args.image_dir, segment_class_idx=segment_class_idx),
...
for X in tqdm(dataloader):
    ...
    # outputs a prediction for each image in a batch ~ 13 images 

    model.validation_step(X)
