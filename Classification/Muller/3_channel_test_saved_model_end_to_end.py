...
import json
import random
with open(model_params['train_label_mapping'], "r") as f: 
    target_mapping_tmp = json.load(f) 
...
for epoch in range(num_epochs):    
    for i, (rgb_image, seg_image, label, _, _, _, img_name) in enumerate(train_data_loader):
        ...
        for qq in range(rgb_image.shape[0]): # query image index 
            # query image
            ...
            if len(possible_positives) != 0:
                ...
                # check if file exist                
                rgb_image_name_p = model_params['msgpack_train_dir2'] + p_file_name
                seg_image_name_p = model_params['msgpack_train_seg_dir'] + p_file_name.replace('.jpg', '.png')
                ...
                if os.path.exists(rgb_image_name_p) and os.path.exists(seg_image_name_p):
                    ...
                    # check if file exist
                    rgb_image_name_n = model_params['msgpack_train_dir2'] + n_file_name
                    seg_image_name_n = model_params['msgpack_train_seg_dir'] + n_file_name.replace('.jpg', '.png')
                    
                    if os.path.exists(rgb_image_name_n) and os.path.exists(seg_image_name_n):
                        ...
                        print('missing negative sample')
                        print(rgb_image_name_n)
                        print(seg_image_name_n)
                    
                else:
                    print('missing positive sample')
                    print(rgb_image_name_p)
                    print(seg_image_name_p)
